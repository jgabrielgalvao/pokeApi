...
function App() {
  ...
  return (
    <div className="container">
      ...
      <div className="stats"><strong>PESO:</strong> {pokemon.weight ? pokemon.weight / 10: 0}kg</div>
      <div className="stats"><strong>ALTURA:</strong> {pokemon.height ? pokemon.height / 10 : 0}m</div>
